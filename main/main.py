...
class Dashboard(BaseModel):
    ...
    active_company_contracts: List[Dict[str, Any]]
...
def admin_dashboard() -> Dashboard:
    ...
    This endpoint intentionally returns mock/sample values so it is deterministic
    and won't raise runtime errors when called.
    """
    ...
    # sample active contracts as plain dictionaries (no Contract wrapper)
    contracts = [
        {
            "id": "C-0001",
